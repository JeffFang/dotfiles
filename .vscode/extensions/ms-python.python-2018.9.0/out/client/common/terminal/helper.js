...
let TerminalHelper = class TerminalHelper {
    constructor(serviceContainer) {
        ...
        this.activatedTerminals = new Set();
    ...
    activateEnvironmentInTerminal(terminal, preserveFocus = true, resource) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const terminalShellType = !shellPath || shellPath.length === 0 ? types_5.TerminalShellType.other : this.identifyTerminalShell(shellPath);
            const activationCommamnds = yield this.getEnvironmentActivationCommands(terminalShellType, resource);
            if (activationCommamnds) {
                for (const command of activationCommamnds) {
                    ...
                    const delay = (terminalShellType === types_5.TerminalShellType.powershell || types_5.TerminalShellType.powershellCore) ? 1000 : 500;
                    yield async_1.sleep(delay);
                }
            }
        });
    }
