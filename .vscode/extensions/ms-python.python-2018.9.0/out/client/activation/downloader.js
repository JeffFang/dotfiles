    ...
    downloadLanguageServer(context) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                telemetry_1.sendTelemetryEvent(constants_2.PYTHON_LANGUAGE_SERVER_DOWNLOADED, timer.elapsedTime, { success, version });
            }
            timer.reset();
            try {
                ...
                telemetry_1.sendTelemetryEvent(constants_2.PYTHON_LANGUAGE_SERVER_EXTRACTED, timer.elapsedTime, { success, version });
