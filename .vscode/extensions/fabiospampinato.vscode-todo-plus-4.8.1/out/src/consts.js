...
const Consts = {
    get() {
        const config = config_1.default.get(), archiveName = _.get(config, 'archive.name') || 'Archive', tagsNames = _.get(config, 'tags.names');
        return {
            languageId: 'todo',
            ...
            colors: {
                ...
                types: _.transform(_.get(config, 'colors.types'), (acc, val, key) => { acc[key.toUpperCase()] = val; }, {})
            },
            tags: {
